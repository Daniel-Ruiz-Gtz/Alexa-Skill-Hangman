...
allWords = ['POSITIVE', 'DEPTH', 'SLOPE', 'COFFEE', 'DRY']
lifes = 3
# A M G
            ...
            if spokenLetterValue not in sessionAttributes["foundLetters"]:
                if spokenLetterValue in sessionAttributes["chosenWord"]:
                    ...
                    if(len(sessionAttributes["foundLocations"]) == len(sessionAttributes["chosenWord"])):
                        ...
                        speak_output = "The letter " + spokenLetterValue + " is present at position " + str(foundLocations) + "."
                else:
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "The game consists in that you must guess the chosen word, you must say letter by letter. If you guess a letter of the word, you will know where it is in the word."
...
class CancelOrStopIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Thank you very much for playing, come back soon"
